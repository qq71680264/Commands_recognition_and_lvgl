...
/**
 * @brief ELECROW-ESP32-S3 I2C GPIO defineation
 * 
 */
...
/**
 * @brief ELECROW-ESP32-S3 SDMMC GPIO defination
 * 
...
/**
 * @brief ELECROW-ESP32-S3 SDSPI GPIO definationv
 * 
 */
...
/**
 * @brief ELECROW-ESP32-S3 I2S GPIO defination
 * 
 */
#define FUNC_I2S_EN         (1)
#define GPIO_I2S_LRCK       (GPIO_NUM_38)
#define GPIO_I2S_MCLK       (GPIO_NUM_NC)
#define GPIO_I2S_SCLK       (GPIO_NUM_39)
